...
def ensure_solver_defaults(args):
    defaults = {
        ...
        "branch_post_gain_floor_adaptive_path": [],
        "branch_post_gain_floor_adaptive_rule": "descent",
        "branch_post_gain_floor_adaptive_margin": 0.0,
        "branch_post_gain_floor_adaptive_progress_fraction": 0.5,
        "branch_post_dim": 0,
